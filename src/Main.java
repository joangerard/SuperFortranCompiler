                ...
                if (!scanner.gotAnyError()) {
                    ...
                    if (!parser.isSyntaxCorrect()) {
                        ...
                        if (argumentHandler.shouldExecuteCode()) {
                            ...
                            String llFile = String.format("%s.ll", autogen);

                            FileHandler.writeInFile(instructions, llFile);
                            output.append(shell.executeCommand(String.format("llvm-as %s -o=%s.bc", llFile, autogen)));
                            if (!shell.getErrorState()) {
                                output.append(shell.executeCommand(String.format("lli %s.bc", autogen)));
                            }
